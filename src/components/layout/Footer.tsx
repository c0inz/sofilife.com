      ...
      <div className="container py-12 md:py-16">
        <div className="grid grid-cols-2 md:grid-cols-4 gap-8 md:gap-12">
          ...
          <div className="col-span-2 md:col-span-1">
            <Link href="/" className="text-title font-medium tracking-tight">
              SofiLife
            </Link>
          ...
          {/* Shop Links */}
          <div>
            <h4 className="text-small font-medium uppercase tracking-wider mb-4">
              Shop
            </h4>
            <ul className="space-y-3">
              {footerLinks.shop.map((link) => (
                <li key={link.href}>
                  <Link
                    href={link.href}
                    className="text-small text-stone hover:text-cream transition-colors"
                  >
                    {link.label}
                  </Link>
                </li>
        ...
        <div className="mt-12 pt-8 border-t border-stone/20">
          <p className="text-caption text-stone text-center">
            © {new Date().getFullYear()} SofiLife. All rights reserved.
          </p>
        </div>
      </div>
    </footer>
